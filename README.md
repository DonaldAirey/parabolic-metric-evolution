<style>
body { max-width: 980px; margin: 0 auto; padding: 2rem; line-height: 1.55; font-family: Georgia, "Times New Roman", serif; color: #111; }
h1, h2, h3 { font-family: Georgia, "Times New Roman", serif; }
h1 { text-align: center; line-height: 1.2; }
.metadata, .keywords { text-align: center; }
.equation { display: grid; grid-template-columns: 1fr minmax(0, auto) 1fr; align-items: center; column-gap: 1rem; margin: 1.15rem 0; width: 100%; }
.eq-math { grid-column: 2; text-align: center; font-family: "Times New Roman", Georgia, serif; font-size: 1.05rem; overflow-x: auto; }
.eq-num { grid-column: 3; justify-self: end; white-space: nowrap; padding-left: 1rem; }
.equation.unnumbered .eq-math { grid-column: 2; }
figure { text-align: center; margin: 1.6rem 0; }
figcaption { font-size: 0.95rem; font-style: italic; max-width: 760px; margin: 0.5rem auto 0; }
...
<div class="equation"><div></div><div class="eq-math">\[\frac{\Delta x_e^1}{L(t_e)}=\frac{\Delta x_o^1}{L(t_o)} .\]</div><div class="eq-num">(1)</div></div>
...
<a id="equation-2"></a>
<div class="equation"><div></div><div class="eq-math">\[\Delta s^1=\Delta x_o^1-\frac12(\Delta x_o^1-\Delta x_e^1),\]</div><div class="eq-num">(2)</div></div>
<a id="eq:spatial_half_expansion"></a>
<div class="equation"><div></div><div class="eq-math">\[\Delta s^1=\frac12(\Delta x_o^1+\Delta x_e^1),\]</div><div class="eq-num">(3)</div></div>
...
<a id="equation-4"></a>
<div class="equation"><div></div><div class="eq-math">\[\Delta s^2 = a\,(\Delta s^0)^2 + b\,(\Delta s^1)^2 + 2c\,\Delta s^0 \Delta s^1 .\]</div><div class="eq-num">(4)</div></div>
...
<div class="equation unnumbered"><div></div><div class="eq-math">\[\Delta s^2 = a (\Delta s^0)^2 + b (\Delta s^1)^2 .\]</div><div></div></div>
...
<div class="equation"><div></div><div class="eq-math">\[\Delta s^2 = (\Delta s^0)^2 + (\Delta s^1)^2 ,\]</div><div class="eq-num">(5)</div></div>
...
<div class="equation unnumbered"><div></div><div class="eq-math">\[v(t) = \int A\, d\chi .\]</div><div></div></div>
...
<div class="equation"><div></div><div class="eq-math">\[v(t) = i(At - V_0),\]</div><div class="eq-num">(6)</div></div>
...
<div class="equation"><div></div><div class="eq-math">\[L(t) = V_0 t - \frac{1}{2} A t^2.\]</div><div class="eq-num">(7)</div></div>
...
<div class="equation"><div></div><div class="eq-math">\[\frac{d^2 L}{dt^2} = -A,\]</div><div class="eq-num">(8)</div></div>
...
<a id="equation-9"></a>
<div class="equation"><div></div><div class="eq-math">\[\Delta s^0 = \int_{t_e}^{t_o} i\left(A t - V_0\right)\,dt .\]</div><div class="eq-num">(9)</div></div>
<p>Evaluating the integral yields</p>
<a id="equation-10"></a>
<div class="equation"><div></div><div class="eq-math">\[\Delta s^0 = i\left(\frac{A}{2}\left(t_o^2 - t_e^2\right) - V_0\left(t_o - t_e\right)\right) .\]</div><div class="eq-num">(10)</div></div>
...
<a id="equation-11"></a>
<div class="equation"><div></div><div class="eq-math">\[\Delta x_e^1 = \Delta x_o^1\,\frac{L(t_e)}{L(t_o)} .\]</div><div class="eq-num">(11)</div></div>
...
<div class="equation"><div></div><div class="eq-math">\[\Delta s^1 =\frac{\Delta x_o^1}{2}\left(1 +\frac{V_0 t_e - \frac{1}{2} A t_e^2}{V_0 t_o - \frac{1}{2} A t_o^2}\right).\]</div><div class="eq-num">(12)</div></div>
...
<div class="equation"><div></div><div class="eq-math">\[\Delta s^2 = \left[i\left(\frac{A}{2}\left(t_o^2 - t_e^2\right) - V_0\left(t_o - t_e\right)\right)\right]^2+ \left[\frac{\Delta x_o^1}{2}\left(1 + \frac{V_0 t_e - \frac{1}{2}A t_e^2}{V_0 t_o - \frac{1}{2}A t_o^2}\right)\right]^2 .\]</div><div class="eq-num">(13)</div></div>
<h3>Redshift Relation</h3>
<p>Redshift is defined observationally by the ratio of observed to emitted wavelength,</p>
<a id="equation-14"></a>
<div class="equation"><div></div><div class="eq-math">\[1+z \equiv \frac{\lambda_o}{\lambda_e}.\]</div><div class="eq-num">(14)</div></div>
...
<div class="equation"><div></div><div class="eq-math">\[1+z = \frac{L(t_o)}{L(t_e)}.\]</div><div class="eq-num">(15)</div></div>
...
<div class="equation"><div></div><div class="eq-math">\[t_e = \frac{V_0(1+z) - \sqrt{(1+z)\big[(V_0 - A t_o)^2 + V_0^2 z\big]}}{A(1+z)},\]</div><div class="eq-num">(16)</div></div>
...
<div class="equation"><div></div><div class="eq-math">\[D_C(z)= \Delta x_o^1= \frac{t_o\left(2V_0 - A t_o\right) z}{2 + z}.\]</div><div class="eq-num">(17)</div></div>
...
<a id="equation-18"></a>
<div class="equation"><div></div><div class="eq-math">\[d_{\mathrm{ch}}(t) = t\left(2V_0 - A t\right) .\]</div><div class="eq-num">(18)</div></div>
<p>Differentiating the causal horizon gives the expansion rate of the causal boundary,</p>
<a id="equation-19"></a>
<div class="equation"><div></div><div class="eq-math">\[c_{\mathrm{c}}(t)=\frac{d}{dt}\,d_{\mathrm{ch}}=2\left(V_0-At\right).\]</div><div class="eq-num">(19)</div></div>
...
<a id="equation-20"></a>
<div class="equation"><div></div><div class="eq-math">\[\frac{d_{\mathrm{ch}}(t)}{L(t)} = 2 .\]</div><div class="eq-num">(20)</div></div>
...
<div class="equation unnumbered"><div></div><div class="eq-math">\[L(t-\Delta t)=L(t)-\dot L(t)\,\Delta t-\frac{1}{2}A\,\Delta t^2,\]</div><div></div></div>
<p>the slice-separation relation gives</p>
<a id="equation-21"></a>
<div class="equation"><div></div><div class="eq-math">\[\frac{\Delta x_e^1}{L(t-\Delta t)}=\frac{\Delta x_o^1}{L(t)} .\]</div><div class="eq-num">(21)</div></div>
<p>Hence</p>
<a id="equation-22"></a>
<div class="equation"><div></div><div class="eq-math">\[\Delta x_e^1=\Delta x_o^1\left(1-\frac{\dot L}{L}\Delta t\right),\]</div><div class="eq-num">(22)</div></div>
<p>so the bilocal spatial component becomes</p>
<a id="equation-23"></a>
<div class="equation"><div></div><div class="eq-math">\[\Delta s^1=\Delta x_o^1\left(1-\frac{1}{2}\frac{\dot L}{L}\Delta t\right)\approx \Delta x_o^1\]</div><div class="eq-num">(23)</div></div>
<p>to leading order in <span class="math">Δ t</span>. Over the same interval, the temporal component is</p>
<a id="equation-24"></a>
<div class="equation"><div></div><div class="eq-math">\[\Delta s^0=\int_{t-\Delta t}^{t} i\left(A t&#x27; - V_0\right)\,dt&#x27; \approx i\left(V_0-At\right)\Delta t.\]</div><div class="eq-num">(24)</div></div>
<p>Substituting these leading terms into equation (5) yields</p>
<a id="eq:local_interval"></a>
<div class="equation"><div></div><div class="eq-math">\[\Delta s^2 \approx -\left(V_0-At\right)^2\Delta t^2 + (\Delta x_o^1)^2 .\]</div><div class="eq-num">(25)</div></div>
...
<a id="equation-26"></a>
<div class="equation"><div></div><div class="eq-math">\[L(t_0+\delta t)=L(t_0)+\dot{L}(t_0)\,\delta t+\frac{1}{2}\ddot{L}(t_0)\,\delta t^2+\cdots .\]</div><div class="eq-num">(26)</div></div>
...
<div class="equation"><div></div><div class="eq-math">\[a_{\mathrm{in}}(x)=a_{\mathrm{bg}}+a_{\mathrm{conc}}(x).\]</div><div class="eq-num">(27)</div></div>
...
<a id="equation-28"></a>
<div class="equation"><div></div><div class="eq-math">\[\mathbf a_{\mathrm{conc}}(r)=a_r(r)\,\hat r.\]</div><div class="eq-num">(28)</div></div>
...
<a id="equation-29"></a>
<div class="equation"><div></div><div class="eq-math">\[\Phi(r)=\oint_S \mathbf a_{\mathrm{conc}}\cdot d\mathbf S
=4\pi r^2 a_r(r).\]</div><div class="eq-num">(29)</div></div>
<p>Imposing flux conservation together with linearity in the enclosed inertial content gives</p>
<a id="eq:aft_flux_integral"></a>
<div class="equation"><div></div><div class="eq-math">\[\oint_S \mathbf a_{\mathrm{conc}}\cdot d\mathbf S = -4\pi G M(r),\]</div><div class="eq-num">(30)</div></div>
...
<a id="equation-31"></a>
<div class="equation"><div></div><div class="eq-math">\[M(r)=\int_V \rho_{\mathrm{inertial}}\,dV,\]</div><div class="eq-num">(31)</div></div>
...
<div class="equation"><div></div><div class="eq-math">\[\mathbf a_{\mathrm{conc}}(r)=-\frac{G M(r)}{r^2}\,\hat r,\]</div><div class="eq-num">(32)</div></div>
<p>and Gauss's theorem gives</p>
<a id="eq:aft_gauss_law"></a>
<div class="equation"><div></div><div class="eq-math">\[\nabla\!\cdot \mathbf{a}_{\mathrm{conc}} = -4\pi G \rho_{\mathrm{inertial}},\]</div><div class="eq-num">(33)</div></div>
...
<a id="equation-34"></a>
<div class="equation"><div></div><div class="eq-math">\[a_{\mathrm{cent}}(r) = -\frac{v^2}{r} .\]</div><div class="eq-num">(34)</div></div>
<p>Equating this with the inward acceleration from equation (27) gives</p>
<a id="equation-35"></a>
<div class="equation"><div></div><div class="eq-math">\[-\frac{v^2}{r} = -A - \frac{G M_b(r)}{r^2} ,\]</div><div class="eq-num">(35)</div></div>
<p>and multiplying by <span class="math">r</span> gives</p>
<a id="equation-36"></a>
<div class="equation"><div></div><div class="eq-math">\[v^2 = A r + \frac{G M_b(r)}{r} .\]</div><div class="eq-num">(36)</div></div>
<p>Then, solving for the enclosed baryonic mass gives</p>
<a id="eq:massradius"></a>
<div class="equation"><div></div><div class="eq-math">\[M_b(r) = \frac{r\left(v^2 - A r\right)}{G}.\]</div><div class="eq-num">(37)</div></div>
...
<a id="equation-38"></a>
<div class="equation"><div></div><div class="eq-math">\[\frac{dM}{dr} = \frac{v^2 - 2 A r}{G} .\]</div><div class="eq-num">(38)</div></div>
<p>The mass therefore reaches a maximum at</p>
<a id="equation-39"></a>
<div class="equation"><div></div><div class="eq-math">\[r_{\max} = \frac{v^2}{2A} .\]</div><div class="eq-num">(39)</div></div>
...
<div class="equation"><div></div><div class="eq-math">\[M_{\max}(v) = \frac{v^4}{4 A G}.\]</div><div class="eq-num">(40)</div></div>
...
<a id="equation-41"></a>
<div class="equation"><div></div><div class="eq-math">\[A = 3.7\times10^{-11}\,\mathrm{m\,s^{-2}} .\]</div><div class="eq-num">(41)</div></div>
...
<a id="equation-42"></a>
<div class="equation"><div></div><div class="eq-math">\[\Phi_{\mathrm{tot}}=\oint \mathbf a_{\mathrm{conc}}\!\cdot d\mathbf S=-4\pi G M_b^{\mathrm{tot}} .\]</div><div class="eq-num">(42)</div></div>
<p>Using the global relation between baryonic mass and the background acceleration scale,</p>
<a id="equation-43"></a>
<div class="equation"><div></div><div class="eq-math">\[M_b^{\mathrm{tot}}=\frac{A L^2}{G},\]</div><div class="eq-num">(43)</div></div>
<p>yields</p>
<a id="equation-44"></a>
<div class="equation"><div></div><div class="eq-math">\[\Phi_{\mathrm{tot}}=-4\pi A L^2 .\]</div><div class="eq-num">(44)</div></div>
...
<a id="equation-45"></a>
<div class="equation"><div></div><div class="eq-math">\[(V_0 - At)^2 \Delta t^2=\Delta x^2,\]</div><div class="eq-num">(45)</div></div>
<p>so that</p>
<a id="equation-46"></a>
<div class="equation"><div></div><div class="eq-math">\[\Delta t=\frac{\Delta x}{(V_0 - At)}.\]</div><div class="eq-num">(46)</div></div>
...
<a id="equation-47"></a>
<div class="equation"><div></div><div class="eq-math">\[ds^2 = -(V_0 - At)^2\,dt^2 + dx^2,\]</div><div class="eq-num">(47)</div></div>
...
<a id="equation-48"></a>
<div class="equation"><div></div><div class="eq-math">\[d\tau^2 = (V_0 - At)^2\,dt^2 - dx^2,\]</div><div class="eq-num">(48)</div></div>
<p>giving</p>
<a id="equation-49"></a>
<div class="equation"><div></div><div class="eq-math">\[d\tau = (V_0 - At)\sqrt{1 - \frac{v^2}{(V_0 - At)^2}}\;dt,\]</div><div class="eq-num">(49)</div></div>
...
<a id="equation-50"></a>
<div class="equation"><div></div><div class="eq-math">\[dx = (V_0 - At)\sin\theta\,d\lambda,\qquad dt = \cos\theta\,d\lambda.\]</div><div class="eq-num">(50)</div></div>
...
<a id="equation-51"></a>
<div class="equation"><div></div><div class="eq-math">\[v = \frac{dx}{dt} = (V_0 - At)\tan\theta.\]</div><div class="eq-num">(51)</div></div>
...
<a id="equation-52"></a>
<div class="equation"><div></div><div class="eq-math">\[P = m\,v,\]</div><div class="eq-num">(52)</div></div>
...
<a id="equation-53"></a>
<div class="equation"><div></div><div class="eq-math">\[P_{\mathrm{geom}} \equiv m(V_0-At),\]</div><div class="eq-num">(53)</div></div>
<p>defines the invariant geometric action increment,</p>
<a id="equation-54"></a>
<div class="equation"><div></div><div class="eq-math">\[dS_{\mathrm{geom}} \equiv P_{\mathrm{geom}}\,ds,\]</div><div class="eq-num">(54)</div></div>
<p>with quadratic form</p>
<a id="equation-55"></a>
<div class="equation"><div></div><div class="eq-math">\[dS_{\mathrm{geom}}^2 = P_{\mathrm{geom}}^2\,ds^2.\]</div><div class="eq-num">(55)</div></div>
<p>Using the local invariant</p>
<a id="equation-56"></a>
<div class="equation"><div></div><div class="eq-math">\[ds^2 = - (V_0 - At)^2 dt^2 + dx^2,\]</div><div class="eq-num">(56)</div></div>
<p>the action-space interval becomes</p>
<a id="equation-57"></a>
<div class="equation"><div></div><div class="eq-math">\[dS_{\mathrm{geom}}^2 =m^2(V_0-At)^2\left[-(V_0-At)^2 dt^2 + dx^2\right].\]</div><div class="eq-num">(57)</div></div>
...
<div class="equation"><div></div><div class="eq-math">\[E_{\mathrm{geom}}(t)\equiv -m(V_0-At)^2,\]</div><div class="eq-num">(58)</div></div>
...
<a id="equation-59"></a>
<div class="equation"><div></div><div class="eq-math">\[ds=(V_0-At)\,d\lambda,\]</div><div class="eq-num">(59)</div></div>
<p>and therefore</p>
<a id="eq:action_definition"></a>
<div class="equation"><div></div><div class="eq-math">\[dS_{\mathrm{geom}} = m(V_0-At)^2\,d\lambda,\]</div><div class="eq-num">(60)</div></div>
<p>so the invariant geometric action accumulates along the manifold tangent,</p>
<a id="equation-61"></a>
<div class="equation"><div></div><div class="eq-math">\[S_{\mathrm{geom}} = \int dS_{\mathrm{geom}}.\]</div><div class="eq-num">(61)</div></div>
<p>Observable action is obtained by projection into the timelike sector,</p>
<a id="equation-62"></a>
<div class="equation"><div></div><div class="eq-math">\[dS = P\,dx - H\,dt,\]</div><div class="eq-num">(62)</div></div>
...
<a id="equation-63"></a>
<div class="equation"><div></div><div class="eq-math">\[\phi = \frac{S_{\mathrm{geom}}}{\hbar},\]</div><div class="eq-num">(63)</div></div>
...
<div class="equation"><div></div><div class="eq-math">\[D_L(z) =-\frac{t_o\left(A t_o - 2V_0\right) z(1+z)}{2+z}.\]</div><div class="eq-num">(64)</div></div>
...
<a id="equation-65"></a>
<div class="equation"><div></div><div class="eq-math">\[\mu(z) = 5\log_{10}\!\left(\frac{D_L(z)}{10\,\mathrm{pc}}\right).\]</div><div class="eq-num">(65)</div></div>
<h3>Manifold Kinematic Parameters</h3>
<p>The local null scale at the observation epoch is</p>
<a id="eq:co_definition"></a>
<div class="equation"><div></div><div class="eq-math">\[c_o = V_0 - A t_o .\]</div><div class="eq-num">(66)</div></div>
...
<div class="equation"><div></div><div class="eq-math">\[V_0 = c_o + A t_o .\]</div><div class="eq-num">(67)</div></div>
...
<a id="equation-68"></a>
<div class="equation"><div></div><div class="eq-math">\[r_i = \mu_{\mathrm{obs}}(z_i) - \mu_{\mathrm{th}}(z_i).\]</div><div class="eq-num">(68)</div></div>
<p>The best-fit observation epoch is obtained by minimizing the covariance-weighted chi-square statistic</p>
<a id="equation-69"></a>
<div class="equation"><div></div><div class="eq-math">\[\chi^2 = r^{\mathrm T} C^{-1} r,\]</div><div class="eq-num">(69)</div></div>
...
<a id="equation-70"></a>
<div class="equation"><div></div><div class="eq-math">\[\chi^2_{\mathrm{PME}}=2726,\qquad \chi^2_{\mathrm{FLRW}}=4049,\]</div><div class="eq-num">(70)</div></div>
...
<div class="equation"><div></div><div class="eq-math">\[H(t) = \frac{V_0 - At}{V_0 t - \frac{1}{2}A t^2}.\]</div><div class="eq-num">(71)</div></div>
...
<a id="equation-72"></a>
<div class="equation"><div></div><div class="eq-math">\[H_0 = 66.5\,\mathrm{km\,s^{-1}\,Mpc^{-1}}.\]</div><div class="eq-num">(72)</div></div>
...
<div class="equation"><div></div><div class="eq-math">\[a(t) = \frac{L(t)}{L(t_o)} .\]</div><div class="eq-num">(73)</div></div>
...
<a id="equation-74"></a>
<div class="equation"><div></div><div class="eq-math">\[M(L)=\frac{4\pi}{3}L^3\rho_b ,\]</div><div class="eq-num">(74)</div></div>
<p>so the corresponding baryon-sourced acceleration at radius <span class="math">L</span> is</p>
<a id="equation-75"></a>
<div class="equation"><div></div><div class="eq-math">\[\frac{GM(L)}{L^2}=\frac{4\pi}{3}G L\rho_b .\]</div><div class="eq-num">(75)</div></div>
...
<a id="equation-76"></a>
<div class="equation"><div></div><div class="eq-math">\[A=\frac{4\pi}{3}G L(t_o)\rho_b ,\]</div><div class="eq-num">(76)</div></div>
<p>hence</p>
<a id="equation-77"></a>
<div class="equation"><div></div><div class="eq-math">\[\rho_b=\frac{3A}{4\pi G\,t_o\left(V_0-\frac{1}{2}A t_o\right)} .\]</div><div class="eq-num">(77)</div></div>
<p>Using the kinematic parameters determined in the previous sections yields</p>
<a id="equation-78"></a>
<div class="equation"><div></div><div class="eq-math">\[\rho_b = 9.49\times10^{-28}\,\mathrm{kg\,m^{-3}}.\]</div><div class="eq-num">(78)</div></div>
...
<a id="equation-79"></a>
<div class="equation"><div></div><div class="eq-math">\[n_\gamma(t)=\frac{2\zeta(3)}{\pi^2}\left(\frac{k_B T_\gamma}{\hbar (V_0-At)}\right)^3 ,\]</div><div class="eq-num">(79)</div></div>
<p>and, following the geometric sign convention of Eq. (58), the mean photon energy is</p>
<a id="equation-80"></a>
<div class="equation"><div></div><div class="eq-math">\[\langle E_\gamma\rangle=-\frac{\pi^4}{30\zeta(3)}k_B T_\gamma .\]</div><div class="eq-num">(80)</div></div>
<p>The corresponding photon energy density is</p>
<a id="equation-81"></a>
<div class="equation"><div></div><div class="eq-math">\[u_\gamma(t)=n_\gamma(t)\langle E_\gamma\rangle ,\]</div><div class="eq-num">(81)</div></div>
<p>so the mass-equivalent photon density becomes</p>
<a id="equation-82"></a>
<div class="equation"><div></div><div class="eq-math">\[\rho_\gamma(t)=\frac{u_\gamma(t)}{-(V_0-At)^2}.\]</div><div class="eq-num">(82)</div></div>
...
<a id="equation-83"></a>
<div class="equation"><div></div><div class="eq-math">\[n_e(t)=x_e(t)\,\frac{\rho_b}{m_p}\,a(t)^{-3},\]</div><div class="eq-num">(83)</div></div>
...
<a id="equation-84"></a>
<div class="equation"><div></div><div class="eq-math">\[\Gamma_T(t)=n_e(t)\,\sigma_T\,(V_0 - At),\]</div><div class="eq-num">(84)</div></div>
...
<a id="equation-85"></a>
<div class="equation"><div></div><div class="eq-math">\[\tau_T(t)=\int_t^{t_o}\Gamma_T(t&#x27;)\,dt&#x27;.\]</div><div class="eq-num">(85)</div></div>
<p>The corresponding visibility function is</p>
<a id="equation-86"></a>
<div class="equation"><div></div><div class="eq-math">\[g(t)=\Gamma_T(t)\,e^{-\tau_T(t)} .\]</div><div class="eq-num">(86)</div></div>
...
<a id="equation-87"></a>
<div class="equation"><div></div><div class="eq-math">\[R(t)=\frac{3\rho_b}{4\rho_\gamma(t)}\,\frac{a(t)^{-3}}{a(t)^{-4}}=\frac{3\rho_b}{4\rho_\gamma(t)}\,a(t),\]</div><div class="eq-num">(87)</div></div>
<p>giving the sound speed</p>
<a id="equation-88"></a>
<div class="equation"><div></div><div class="eq-math">\[c_s(t)=\frac{c_{\mathrm{c}}(t)}{\sqrt{3\left(1+R(t)\right)}} .\]</div><div class="eq-num">(88)</div></div>
...
<a id="equation-89"></a>
<div class="equation"><div></div><div class="eq-math">\[r_s=\int_0^{t_*} c_s(t)\,dt .\]</div><div class="eq-num">(89)</div></div>
...
<div class="equation"><div></div><div class="eq-math">\[C_\perp \equiv \frac12\left[L(t_o)+L(t_*)\right].\]</div><div class="eq-num">(90)</div></div>
<p>Using the redshift relation from equation (15), this becomes</p>
<a id="equation-91"></a>
<div class="equation"><div></div><div class="eq-math">\[C_\perp=\frac{L(t_o)}{2}\,\frac{2+z_*}{1+z_*}.\]</div><div class="eq-num">(91)</div></div>
<p>The corresponding effective transverse radius is</p>
<a id="equation-92"></a>
<div class="equation"><div></div><div class="eq-math">\[r_\perp=\frac{C_\perp}{2\pi}=\frac{L(t_o)}{4\pi}\,\frac{2+z_*}{1+z_*}.\]</div><div class="eq-num">(92)</div></div>
<p>The acoustic angular scale is then</p>
<a id="equation-93"></a>
<div class="equation"><div></div><div class="eq-math">\[\theta_*=\frac{r_s}{r_\perp}.\]</div><div class="eq-num">(93)</div></div>
<p>Substituting the expression above for <span class="math">r_\perp</span> gives</p>
<a id="equation-94"></a>
<div class="equation"><div></div><div class="eq-math">\[\theta_*=\frac{4\pi(1+z_*)}{L(t_o)(2+z_*)}\,r_s.\]</div><div class="eq-num">(94)</div></div>
<p>Using equation (7) evaluated at <span class="math">t_o</span> yields</p>
<a id="eq:acoustic_angle_final"></a>
<div class="equation"><div></div><div class="eq-math">\[\theta_*=\frac{8\pi(1+z_*)}{t_o(2V_0-A t_o)(2+z_*)}\,r_s.\]</div><div class="eq-num">(95)</div></div>
<p>Evaluating this expression with the manifold parameters gives</p>
<a id="equation-96"></a>
<div class="equation"><div></div><div class="eq-math">\[\theta_* = 0.0103.\]</div><div class="eq-num">(96)</div></div>
<p>Expressed in the conventional CMB notation,</p>
<a id="equation-97"></a>
<div class="equation"><div></div><div class="eq-math">\[100\,\theta_* = 1.03.\]</div><div class="eq-num">(97)</div></div>
